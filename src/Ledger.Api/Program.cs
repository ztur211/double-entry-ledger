...
app.Use(async (context, next) =>
{
    try
    {
        ...
        {
            throw Problem.Invalid("Request body must be JSON with UTF-8 encoding");
        }
...
// Define how failures are displayed
...
// GET /health: 200 only when database is reachable, otherwise 503
